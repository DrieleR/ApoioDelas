  ...
  return (
    <section className="flex flex-col items-center justify-center px-6 py-16">
        <div className="w-full max-w-2xl flex flex-col gap-4">
            {cardsLink.map((card) => (
                <div key={card.title}
                className="bg-[#ff7552b9] rounded-2xl shadow-md p-6 flex items-center gap-6 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
                    {/* Icone */}
                    <div className="shrink-0 bg-white/40 rounded-2xl p-4">
                        {card.icon}
                    </div>
